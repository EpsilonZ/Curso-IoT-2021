...
extern int begin_index_gyro;
extern int begin_index_acc;
extern TfLiteStatus SetupAccelerometer(tflite::ErrorReporter* error_reporter);
extern TfLiteStatus SetupGyroscope(tflite::ErrorReporter* error_reporter);
extern bool ReadAccelerometer(tflite::ErrorReporter* error_reporter,
                              float* input, int length);
extern bool ReadGyroscope(tflite::ErrorReporter* error_reporter,
                              float* input, int length);
extern bool ReadIMUData(tflite::ErrorReporter* error_reporter,
                              float* input, int length);
